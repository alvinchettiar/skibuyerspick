...
if(isset($_POST['email']) || $_POST['email']!="" || $_POST['password']!="" || $_POST['c_password']!="")
{
	...
	if($password==$c_password)
	{
		...
		$sqlUpdate  = mysql_query("update ba_tbl_user set password = '$password', old_password = '$current_password', verification_key = '', last_modified = '$datetime', password_mod = 0 where email = '$email'")  or die(mysql_error());
